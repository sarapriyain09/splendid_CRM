...
const ITEMS = ['Leads', 'Opportunities', 'Pipeline', 'Quotations', 'Forecasts'];
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-600 mt-1">Sales features are hosted in the dedicated Sales app.</p>
      </div>

...
export default function ProspectFinderPage() {
  ...
  const displayed = results
    .filter(r => filterLabel === 'all' || r.analysis?.opportunityLabel === filterLabel || (filterLabel !== 'all' && !r.analysis))
    .sort((a, b) => {
      if (sortBy === 'score') {
      ...
      {notConfigured && (
        <div className="bg-amber-900/20 border border-amber-700 rounded-xl p-5 space-y-3">
          ...
          <ol className="text-sm text-slate-400 space-y-1 list-decimal list-inside">
            ...
            <li>Create <span className="font-mono text-slate-300">.env.local</span> in the project root</li>
            <li>Add: <span className="font-mono text-slate-200 bg-slate-800 px-2 py-0.5 rounded">NEXT_PUBLIC_GOOGLE_PLACES_API_KEY=your_key_here</span></li>
